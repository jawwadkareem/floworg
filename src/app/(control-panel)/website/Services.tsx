          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                ...
                your business processes, enhance customer experiences, and drive
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group cursor-pointer">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Learn about common mistakes in mobile app marketing and how to
                avoid them for successful launches.
              </p>
            ...
            <div className="group cursor-pointer">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Discover proven frameworks for scaling social commerce
                operations and maximizing performance.
              </p>
              <div className="mt-4 text-xs text-gray-500">
            ...
            <div className="group cursor-pointer">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Essential priorities to focus on each quarter to maintain and
