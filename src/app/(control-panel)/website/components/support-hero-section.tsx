...
const SupportHeroSection: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Navbar Section (outside teal) */}
      <section className="bg-gray-100 border-t border-gray-200 py-2">
        <div className="container mx-auto px-4 max-w-7xl">
          <motion.div
          ...
          >
            {tabs.map((tab, index) => (
              <button
                ...
                className={`relative px-6 py-3 font-medium text-sm md:text-base transition-all duration-300 border-b-2
                  ${
                    activeTab === tab.id
