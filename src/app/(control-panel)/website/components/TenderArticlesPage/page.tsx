...
import TenderNavbar from "./tender-navbar"
import JobOpeningsSection from "../CareerApplicationPage/job-openings-section"
import JobPostingSection from "../CareersArticlePage/job-posting-section"
...
const TenderArticlespage: React.FC = () => {
  return (
    <>
...
export default TenderArticlespage;
