...
export interface KnowledgeBaseNavbarHeaderProps {
...
const KnowledgeBaseNavbarHeader: React.FC<KnowledgeBaseNavbarHeaderProps> = ({
  tabs = [
  ...
  const handleTabChange = (tabId: string) => {
    setActiveTab(tabId);
    onTabChange?.(tabId);
    console.log(`Active knowledge base tab changed to: ${tabId}`);
  };
          ...
          >
            {tabs.map((tab, index) => (
              ...
              >
                ...
                {activeTab === tab.id && (
                  <motion.div
                    layoutId="activeKnowledgeBaseTabIndicator"
...
export default KnowledgeBaseNavbarHeader;