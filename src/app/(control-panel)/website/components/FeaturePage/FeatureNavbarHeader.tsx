...
export interface FeatureNavbarHeaderProps {
  tabs?: FeatureTab[];
...
const FeatureNavbarHeader: React.FC<FeatureNavbarHeaderProps> = ({
  tabs = [
  ...
  const handleTabChange = (tabId: string) => {
    setActiveTab(tabId);
    onTabChange?.(tabId);
    console.log(`Active feature tab changed to: ${tabId}`);
  };
...
export default FeatureNavbarHeader;