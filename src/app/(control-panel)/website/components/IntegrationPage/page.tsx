...
import StreamlineProcessesSection from "./StreamlineProcessSection"
import FlowIntegrationsSection from "./FlowIntegrationSection"
import SupportBlogSection from "../support-blog-section"
import RoadMapJourneySection from "./RoadmapJourneySection"
...
const Integrationpage: React.FC = () => {
  return (
    <>
      ...
      <StreamlineProcessesSection />
      <FlowIntegrationsSection />
