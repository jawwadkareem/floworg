...
const LeadsForm: React.FC<LeadsFormProps> = ({ onSubmit, className = "" }) => {
  ...
  return (
    <div className="py-16 bg-gradient-to-r from-purple-100 via-purple-200 to-purple-300">
      <motion.div
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8 }}
        viewport={{ once: true }}
        className={`grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto px-6 ${className}`}
      >
