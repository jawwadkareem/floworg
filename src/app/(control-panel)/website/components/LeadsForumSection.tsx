        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-4">Leads Forum</h1>
              <div className="inline-flex items-center gap-2 bg-purple-200 text-purple-700 px-4 py-2 rounded-full text-sm font-medium mb-8">
                <span className="text-purple-500">✨</span>
                Unlock AI For Smarter Businesses
              </div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 leading-tight mb-6">
                Transform Your <span className="text-green-500">Business</span> with{" "}
                <span className="text-orange-500">AI</span>
              </h2>
              <p className="text-gray-700 leading-relaxed text-base mb-8 max-w-md">
                Experience the power of AI-driven software that transforms your workflow, automates repetitive tasks.
              ...
              <div className="flex items-center gap-8">
                <div className="flex items-center gap-3">
                  <div className="flex -space-x-2">
                    <img
                      src="https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=32"
                      alt="Customer"
                    ...
                    />
                    <img
                      src="https://images.pexels.com/photos/415829/pexels-photo-415829.jpeg?auto=compress&cs=tinysrgb&w=32"
                      alt="Customer"
                      className="w-8 h-8 rounded-full border-2 border-white"
                    />
                  </div>
          ...
          {/* Right Side - Form (replacing dashboard mockups) */}
          <div>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
              whileInView={{ opacity: 1, x: 0 }}
            ...
            >
              <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 shadow-lg space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors"
                >
                  Submit
                </button>
              </form>
